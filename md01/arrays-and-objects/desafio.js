...
// Dar um console.log do nome dos filmes

// for (let i = 0; i < movies.length; i++) {
//   console.log(movies[i].original_title);
// }

// Dar um console.log dos overviews dos filmes que tem nota maior que 7.5
// const date = new Date();
// console.log(date);
// console.log(typeof date);

// for (let i = 0; i < movies.length; i++) {
//   if (movies[i].vote_average >= 7.5) {
//     console.log(movies[i].overview);
//   }
// }

// for (let i = 0; i < movies.length; i++) {
//   if (movies[i].release_date > "2021-12-14") {
//     console.log(movies[i].original_title);
//   }
// }

// Dar um console.log do titulo de cada filme junto com o overview no seguinte formato:

// "Titulo: "TAL", Overview: "TAL" "

// for (let i = 0; i < movies.length; i++) {
//   console.log(
//     `Titulo: ${movies[i].original_title}, Overview: ${movies[i].overview}, Nota: ${movies[i].vote_average}`
//   );
// }

for (let i = 0; i < movies.length; i++) {
  console.log(`Titulo: ${movies[i].original_title}`);

  const newArray = [...movies[i].genre_ids];

  //   console.log("Ids dos generos:", );

  console.log(`Alguma coisa ${newArray}`);
}
